  ...
  return (
    <div className="space-y-8 pb-16">
      <div className="text-center">
        <h1 className="text-4xl font-black uppercase italic text-glow dark:text-white text-slate-900">Hall of Fame</h1>
        <p className="dark:text-brand-light text-slate-600 mt-2">Top players based on performance and wins</p>
      </div>
      ...
      {leaderboard.length >= 3 && (
        <div className="flex justify-center items-end gap-2 md:gap-6 pt-10 pb-8 px-2 overflow-x-auto">
          {/* Rank 2 */}
          <div className="glass-card flex flex-col items-center w-28 md:w-40 pb-6 dark:border-white/20 border-slate-300 relative mt-10">
            ...
            <h3 className="font-bold text-center truncate w-full px-2 dark:text-white text-slate-900">{leaderboard[1].playerName}</h3>
          ...
          {/* Rank 1 */}
          <div className="glass-card flex flex-col items-center w-32 md:w-48 pb-8 dark:border-yellow-500/50 border-yellow-500 relative shadow-[0_0_30px_rgba(234,179,8,0.2)] z-10">
            ...
            <h3 className="font-bold text-center text-lg truncate w-full px-2 dark:text-white text-slate-900">{leaderboard[0].playerName}</h3>
            <p className="text-yellow-400 font-black text-xl">{leaderboard[0].points} PTS</p>
            <div className="text-xs dark:text-brand-light text-slate-500 mt-1">{leaderboard[0].kills} Kills</div>
          ...
          {/* Rank 3 */}
          <div className="glass-card flex flex-col items-center w-28 md:w-40 pb-6 dark:border-orange-700/50 border-orange-700 relative mt-16">
            ...
            <h3 className="font-bold text-center truncate w-full px-2 dark:text-white text-slate-900">{leaderboard[2].playerName}</h3>
          ...
          <table className="w-full text-left text-sm md:text-base">
            ...
            <tbody>
              {leaderboard.map((p, index) => (
                <tr key={p.id} className="border-b dark:border-white/5 border-slate-100 dark:hover:bg-white/5 hover:bg-slate-50 transition-colors dark:text-white text-slate-900">
                  <td className="py-4 pl-4 font-bold dark:text-brand-light text-slate-500">#{index + 1}</td>
                  <td className="py-4 font-bold flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full dark:bg-white/10 bg-slate-200 flex items-center justify-center text-xs">
                  ...
                  <td className="py-4 text-right pr-4 text-green-600 dark:text-green-400 font-bold">₹{p.totalPrize}</td>
                </tr>
              ))}
            </tbody>
          </table>
